...
struct HandComposeView: View {
    ...
    private struct PlayerHandGrid: View {
        ...
        private var header: some View {
            let totalCount = cardsBySuit.values.reduce(0) { $0 + $1.count }
            return HStack {
                Text(title)
                    .font(.callout)
    ...
    var body: some View {
        ...
        .overlay(alignment: .topLeading) {
            ...
            VStack(alignment: .leading, spacing: 6) {
                ...
                Text("A Bridge Hand Composer by G Dawson")
                ...
                Text("A deal generator with hands saved in .pbn format for use by bridge teachers. Coded for macOS")
                    .font(.title2).bold()
                    .foregroundStyle(.secondary)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.leading, 92)
                ...
                Text("Guide : [New Session] > Name session > [Save] (a file is generated) > Select the [N] [S] [E] or [W] tabs in turn > Deal the cards [A...2] > Record > Add to Library > Next hand")
                    .font(.title3)
                    .foregroundStyle(.secondary)
                    .frame(maxWidth: .infinity, alignment: .leading)
                    .padding(.leading, 92)
