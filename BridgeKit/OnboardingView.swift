                ...
                TabView(selection: $selection) {
                    OnboardingPage(
                        ...
                        bullets: [
                            ...
                            AnyView(HStack(spacing: 0) { bullet(text: "OR go to "); colored("Library" , .yellow); bullet(text: ", for a selection of composed deals") }),
                    ...
                    OnboardingPage(
                        ...
                        bullets: [
                            ...
                            AnyView(HStack(spacing: 0) { bullet(text: "Tap "); colored("⊕Library", .red); bullet(text: " to save current deal to the Library.") }),
                            AnyView(HStack(spacing: 0) { bullet(text: "Then choose "); colored("Next hand", .yellow); bullet(text: " to continue.") }),
                            AnyView(HStack(spacing: 0) { bullet(text: "Add new categories to the Library with simple steps.") }),
                            AnyView(HStack(spacing: 0) { bullet(text: "Aggregate files to build a new session.") })
                        ],
